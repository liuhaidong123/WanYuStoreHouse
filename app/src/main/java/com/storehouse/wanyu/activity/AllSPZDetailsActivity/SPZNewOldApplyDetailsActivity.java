        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 15) {
                try{
                    ...
                    Toast.makeText(SPZNewOldApplyDetailsActivity.this, "数据解析错误,请重新尝试", Toast.LENGTH_SHORT).show();
                    mNoData_rl.setVisibility(View.VISIBLE);
                    no_mess_tv.setText("数据解析错误,请重新尝试");
                }

            } else if (msg.what == 1010) {
                Toast.makeText(SPZNewOldApplyDetailsActivity.this, "连接服务器失败,请检查网络", Toast.LENGTH_SHORT).show();
                mNoData_rl.setVisibility(View.VISIBLE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNoData_rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mReferId != -1) {
                    //请求详情
                    BallProgressUtils.showLoading(SPZNewOldApplyDetailsActivity.this,mNoData_rl);
                    NO_Url = URLTools.urlBase + URLTools.newold_details_url + "id=" + mReferId;
                    okHttpManager.getMethod(false, NO_Url, "申请详情", handler, 15);
                } else {
                    Toast.makeText(SPZNewOldApplyDetailsActivity.this, "获取详情ID错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
