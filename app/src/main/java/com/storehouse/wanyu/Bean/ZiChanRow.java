...
public class ZiChanRow {
   ...
   // private PassEntryTime passEntryTime;

    private long trade;

    private long residualRate;
    ...
    public String getPassEntryTimeString() {
        return passEntryTimeString;
    }

    public void setPassEntryTimeString(String passEntryTimeString) {
    ...
    public String getAssetStateName() {
        return assetStateName;
    }

    public void setAssetStateName(String assetStateName) {
        this.assetStateName = assetStateName;
    }
    ...
    public long getResidualRate() {
        return residualRate;
    }

    public void setResidualRate(long residualRate) {
