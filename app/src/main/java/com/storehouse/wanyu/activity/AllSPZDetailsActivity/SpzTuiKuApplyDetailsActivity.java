            ...
            if (msg.what == 15) {
                ...
                if (o != null && o instanceof TuiKuDetailsRoot) {
                    ...
                    if (tuiKuDetailsRoot != null && "0".equals(tuiKuDetailsRoot.getCode())) {
                        ...
                        Toast.makeText(SpzTuiKuApplyDetailsActivity.this, "获取详情数据失败", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(SpzTuiKuApplyDetailsActivity.this, "获取详情错误", Toast.LENGTH_SHORT).show();
