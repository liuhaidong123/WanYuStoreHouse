...
public class JieYongDetailsRows {
    ...
    private List<JieYongDetailsListBean> assetList;
    ...
    public List<JieYongDetailsListBean> getAssetList() {
        return assetList;
    }

    public void setAssetList(List<JieYongDetailsListBean> assetList) {
