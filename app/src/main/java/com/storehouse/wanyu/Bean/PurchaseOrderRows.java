...
/**
 * Created by liuhaidong on 2018/12/17.
 */
...
public class PurchaseOrderRows {
    ...
    public int getAcceptanceOpinion() {
        return acceptanceOpinion;
    }

    public void setAcceptanceOpinion(int acceptanceOpinion) {
    ...
    public void setAcceptanceUserId(int acceptanceUserId) {
    ...
    public int getBuyCate() {
        return buyCate;
    }

    public void setBuyCate(int buyCate) {
