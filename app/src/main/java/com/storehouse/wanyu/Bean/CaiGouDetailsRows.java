...
public class CaiGouDetailsRows {
    ...
    private long acceptanceOpinion;
    ...
    public long getAcceptanceOpinion() {
        return acceptanceOpinion;
    }

    public void setAcceptanceOpinion(long acceptanceOpinion) {
    ...
    public long getBuyCate() {
        return buyCate;
    }

    public void setBuyCate(long buyCate) {
