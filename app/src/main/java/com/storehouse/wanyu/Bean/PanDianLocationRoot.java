...
public class PanDianLocationRoot {
    private int total;
    ...
    private List<PanDianLocationRows> rows;
    ...
    public List<PanDianLocationRows> getRows() {
        return rows;
    }

    public void setRows(List<PanDianLocationRows> rows) {
        this.rows = rows;
    }
